...
export const sampleLessons:Lesson[] = [
  ...
  { ...lesson(2,20260112,900,945,202,"DEU","Deutsch",302,"LEH2","Lehrkraft 2",402,"R-102","Raum 102","7A-DEU"), code:"cancelled", substText:"Unterricht entfällt" },
  lesson(3,20260113,800,845,203,"ENG","Englisch",303,"LEH3","Lehrkraft 3",403,"R-103","Raum 103","7A-ENG"),
  { ...lesson(4,20260113,1000,1045,204,"SPO","Sport",304,"LEH4","Lehrkraft 4",404,"HAL-A","Sporthalle A","7A-SPO"), ro:[{id:409,name:"HAL-B",longname:"Sporthalle B",orgid:404,orgname:"Sporthalle A"}], substText:"Hallenwechsel" },
  ...
  { ...lesson(8,20260115,1000,1045,208,"MUS","Musik",303,"LEH3","Lehrkraft 3",408,"MUS-A","Musikraum A","7A-MUS"), activityType:"Event" },
