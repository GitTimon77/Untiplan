...
export type UntisMessageAttachment = { id: string; name: string; kind: "image" | "pdf" | "file" };
...
export type Homework = { id: number; lessonId?: number; assignedDate: number; dueDate: number; text: string; subject: string; teacher: string; completed: boolean; attachmentCount: number };
