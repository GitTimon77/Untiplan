...
export const metadata: Metadata = { title: { default: "Untiplan", template: "%s · Untiplan" }, description: "Ein übersichtlicher, filterbarer WebUntis-Stundenplan", applicationName: "Untiplan", icons: { icon: "/untiplan-logo.png", apple: "/untiplan-logo.png" }, appleWebApp: { capable: true, title: "Untiplan", statusBarStyle: "black-translucent" } };
