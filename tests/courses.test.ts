...
const lessons=[{id:1,date:20260824,startTime:800,endTime:845,su:[{id:10,name:"M",longname:"Mathematik"}],te:[{id:21,orgid:20,name:"NEU",orgname:"ALT"}],ro:[]},{id:2,date:20260824,startTime:900,endTime:945,su:[{id:11,name:"D"}],te:[{id:30,name:"MU"}],ro:[]}];
