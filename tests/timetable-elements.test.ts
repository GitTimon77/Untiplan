...
test("sorts timetable elements alphabetically with natural numbers", () => {
  const sorted = sortTimetableElements([
    { id: 3, type: 1, name: "10F", longname: "Beispielklasse F" },
    { id: 2, type: 1, name: "5B", longname: "Beispielklasse B" },
    { id: 1, type: 1, name: "5A", longname: "Beispielklasse A" },
    { id: 4, type: 2, name: "ZET", longname: "Lehrkraft Zeta" },
    { id: 5, type: 2, name: "ALP", longname: "Lehrkraft Alpha" },
  ]);
...
test("shows the abbreviation after the full name when both are available", () => {
  assert.equal(timetableElementLabel({ id: 1, type: 2, name: "ALP", longname: "Lehrkraft Alpha" }), "Lehrkraft Alpha (ALP)");
